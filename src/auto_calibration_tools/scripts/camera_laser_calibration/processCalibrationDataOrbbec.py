...
class ImagePointFinder:
    ...
    def __init__(self, plotter=None, rep=None, scale=1):
        ...
        model_state_dict = torch.load("one_shot_object_detector_orbbec.pth")
        model_state_dict_side = torch.load("one_shot_object_detector_orbbec.pth")
    ...
    with open(csv_file_path, mode='r') as csvfile:
        ...
        for i, row in enumerate(csvreader):
            ...
            if img_results is not None:
                ...
                if laser_results is not None:
                    ...
                    if verbose:
                        ...
                        plotter.save("pano_process", os.path.splitext(bag_name)[0], subfolder="indoor")
            ...
            if i%50 == 0:
                ...
                file_path = "cameraLaser_pointsUHD_orbbec.pkl"
